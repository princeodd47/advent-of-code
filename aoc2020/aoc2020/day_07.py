...
def part1():
    ...
    print(_get_max_bag_count("input/day_07", desired_bag))


def part2():
    print(_do_the_thing("input/day_07"))


def _get_max_bag_count(input_file, desired_bag):
