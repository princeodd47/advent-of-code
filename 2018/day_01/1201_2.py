...
while duplicate_found != True:
    for num in nums:
        total += num
        if total in freq_found:
            duplicate_found = True
            print("duplicate found: {}".format(total))
            print("interations: {}".format(i))
            break
        else:
            freq_found.append(total)
            i += 1

#for freq in freq_found:
#    print(freq)

print(total)

#[spowell/advent] time python 1201_2.py
#duplicate found: 464
#interations: 135570
#464
#python 1201_2.py  121.58s user 0.18s system 99% cpu 2:01.77 total
